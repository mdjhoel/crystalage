        ...
        <div class="card" style="max-width: 500px; margin-top: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 1.5rem;">
                ...
                <div>
                    ...
                    <a href="mailto:crystalagedev@mail.com" style="color: #2c3e50; text-decoration: none; font-weight: 500; transition: color 0.2s;" onmouseover="this.style.color='#f39c12'" onmouseout="this.style.color='#2c3e50'">crystalagedev@mail.com</a>
                </div>
            </div>
